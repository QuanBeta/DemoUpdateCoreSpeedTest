package com.example.demoupdatecorespeedtest.util_speedtest;
...
public class GetSpeedTestHostsHandler extends Thread {
    private static final String TAG = "get host";
